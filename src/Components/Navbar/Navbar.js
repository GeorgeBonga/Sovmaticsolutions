...
import Logo from "../../images/nlogoo.png"
    ...
    >
      <div className="flex flex-row justify-between items-center py-2">
        <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
          <Link to="/">
            <h1 className="font-extrabold italic text-3xl text-custom font-beautiful">
              SovMatic <span className="text-xs">solutions</span>
              {/* <img src="https://www.postermywall.com/index.php/posterbuilder/view/f7cbe3d0352797cb63be365239d02100/1" alt="Logo" /> */}
